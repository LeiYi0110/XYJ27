...
cursorXYJ.execute('select * from restaurant')
hotelList = []
...
for hotelItem in hotelList:
    ...
    cursorXYJ.execute('select * from entity_image where entity_type = 2 and entity_id = ' + str(hotelItem[0]))
    imageList = []
    cover = ""
    ...
    '''
    db.restaurant.insert({"shop_id": "", "restaurant_name": hotelItem[5], "restaurant_desc": hotelItem[4], "restaurant_address": hotelItem[3],
                     "restaurant_telephone": hotelItem[2], "city_id": hotelItem[18], "area_id": hotelItem[19], "province": hotelItem[20],
                     "city": hotelItem[21], "town": hotelItem[22], "village": hotelItem[23], "tour_id":hotelItem[17],
                     "gps": {"longitude": hotelItem[6], "latitude": hotelItem[7]}, "create_time": datetime.now(),
                     "update_time": datetime.now(), "lowest_price": 0.0, "room_value": 0.0, "location_value": 0.0,
                     "service_value": 0.0, "avg_price": 0.0, "star_count": 0.0, "cover": cover, "images": imageList})
    '''
    db.restaurant.insert({"shop_id": "", "restaurant_name": hotelItem[5], "restaurant_address": hotelItem[3],"hotel_desc":"",
                     "restaurant_telephone": hotelItem[2], "city_id": hotelItem[18], "area_id": hotelItem[19], "province": hotelItem[20],
                     "city": hotelItem[21], "town": hotelItem[22], "village": hotelItem[23], "tour_id":hotelItem[17],
                     "gps": {"longitude": hotelItem[6], "latitude": hotelItem[7]}, "create_time": datetime.now(),
                     "update_time": datetime.now(), "lowest_price": 0.0, "room_value": 0.0, "location_value": 0.0,
