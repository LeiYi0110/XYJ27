...
cursorXYJ.execute('select * from sights')
hotelList = []
...
for hotelItem in hotelList:
    ...
    cursorXYJ.execute('select * from entity_image where entity_type = 3 and entity_id = ' + str(hotelItem[0]))
    imageList = []
    cover = ""
    ...
    '''
    db.sights.insert({"shop_id": "", "sights_name": hotelItem[2], "sights_desc": hotelItem[3], "sights_address": hotelItem[9],
                     "sights_telephone": hotelItem[8], "city_id": hotelItem[17], "area_id": hotelItem[18], "province": hotelItem[19],
                     "city": hotelItem[20], "town": hotelItem[21], "village": hotelItem[22], "tour_id":hotelItem[25],
    ...
    '''
    db.sights.insert({"shop_id": "", "sights_name": hotelItem[2], "sights_address": hotelItem[9],"hotel_desc":"",
                     "sights_telephone": hotelItem[8], "city_id": hotelItem[17], "area_id": hotelItem[18], "province": hotelItem[19],
                     "city": hotelItem[20], "town": hotelItem[21], "village": hotelItem[22], "tour_id":hotelItem[25],
                     "gps": {"longitude": hotelItem[6], "latitude": hotelItem[7]}, "create_time": datetime.now(),
                     "update_time": datetime.now(), "lowest_price": 0.0, "room_value": 0.0, "location_value": 0.0,
